...
Power prior analysis treated the 11 pre-ISIS-4 trials as prior evidence and ISIS-4 as the primary RCT evidence. Table 5 presents results across the discounting grid, with the full forest plot in Fig. 4.
...
Power prior analysis treated observational studies as prior evidence and the two RCTs as primary evidence. Table 6 presents results, with the full forest plot in Fig. 6.
