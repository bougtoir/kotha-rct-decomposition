...
def _build_markdown():
    ...
    mg_kotha_abstract = v['mg_kotha_classification'].lower()
    st_kotha_abstract = v['st_kotha_classification'].lower()
...
**Conclusions**: KOTHA provides a reproducible, quantitative method to distinguish "evidence of no effect" from "no evidence of effect" and to inform trial design, evidence synthesis, and guideline interpretation. Module H classified magnesium as {mg_kotha_abstract}, and statins as {st_kotha_abstract}."""
