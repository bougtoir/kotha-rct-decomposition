...
export function StatisticsPane({ paper }: Props) {
  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
      <StatCard value={s.wordCount} label="Word Count" limit={s.wordLimit} />
      <StatCard value={s.figureCount} label="Figures" limit={s.figureLimit} />
      <StatCard value={s.tableCount} label="Tables" limit={s.tableLimit} />
      <StatCard value={s.referenceCount} label="References" limit={s.referenceLimit} />
    </div>
  );
}
